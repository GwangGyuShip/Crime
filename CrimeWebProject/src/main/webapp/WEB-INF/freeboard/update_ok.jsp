...
<body>
	<div class="container">
		<div class="row">
			...
			<!-- 모든데이터를 컨트롤러에게 전송 -->
			<form:form method="post" action="update_ok.do"
				...
				<table class="table table-hover">
					...
					<tr>
						...
						<td width=80% class="text-left"><input type=text
							name=board_name size=15 value=${vo.board_name }></td>
					</tr>
					...
					<tr>
						...
						<td width=80% class="text-left"><input type=text
							name=board_subject size=45 value=${vo.board_subject }></td>
					</tr>
					...
					<tr>
						...
						<td width=80% class="text-left"><textarea rows="10" cols="50"
								name="board_content">${vo.board_content }</textarea></td>
					</tr>
