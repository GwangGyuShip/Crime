...
public class BoardVO {
	...
	private String board_name; // 게시글 닉네임
	private String board_subject; // 게시글 제목
	private String board_content; // 게시글 내용
	private String board_pwd; // 게시글 비밀번호
	private Date board_regdate; // 게시글 날짜
	private int board_hit; // 게시글 조회수
	private String board_group; // 게시글 동네
	private String board_area; // 게시글 분류
	private String board_ip; // ip
	private String board_filename; // 게시글 파일 이름
	private String board_filesize; // 게시글 파일 사이즈
	private int board_filecount; // 게시글 파일 갯수
